...
turbobuild benchmark --project path\to\project --runs 50 --max-noise 10 --command ".\app.exe"
turbobuild benchmark --project path\to\project --runs 50 --budget-ms 25 --command ".\app.exe"
...
turbobuild results --project path\to\project --latest
